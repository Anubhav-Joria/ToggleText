...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'#000000'}}> 
            ...
            <div className="mb-3"> 
            <textarea className="form-control" value={text} onChange={handleOnChange} style={{backgroundColor: props.mode==='dark'?'rgb(33 38 42)':'white', color: props.mode==='dark'?'white':'#000000'}} id="myBox" rows="8"></textarea>
            </div>
